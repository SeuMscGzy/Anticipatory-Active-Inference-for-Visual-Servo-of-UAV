...
#动捕节点
roslaunch vrpn_client_ros sample.launch server:=192.168.1.5 & sleep 2;

#mavrso节点 并提升imu数据频率
#roslaunch mavros px4.launch & sleep 2;
#roslaunch mavros px4.launch gcs_url:=udp://@192.168.66.206 & sleep 3;
roslaunch mavros px4.launch gcs_url:=udp://@192.168.1.2 & sleep 3;
...
rosrun topic_tools relay /vrpn_client_node/GZY0/0/pose /mavros/vision_pose/pose & sleep 2;
